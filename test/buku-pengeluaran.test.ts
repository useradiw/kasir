...
describe("buku page auth-gate guard", () => {
  ...
  it("every other app/buku/**/page.tsx calls requireCan(\"buku.read\")", () => {
    // belanja is requireAuth()-gated on purpose (guarded above) and is the
    // ONLY exception. The permission screen briefly lived here too; it moved
    // to /admin/izin on 2026-09-07, which put this rule back to one exception.
